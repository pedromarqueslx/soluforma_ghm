...
<?php echo form_open('servicos/edit/'.$servicos_item['id']); ?>
<form>
<div class="container">
<div class="row">
...
<div class="col-md-4">                    
    <label>Descrição da Infracção</label>
    <div class="control">
...
<div class="col-md-8">
    ...
    <a class="btn btn-primary" href="<?php echo base_url("/index.php/discos/pdf/". $servicos_item['id'] ); ?>" target="_blank">Emitir Certificado</a>
