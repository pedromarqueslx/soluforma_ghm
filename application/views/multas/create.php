<?php echo form_open('multas/create'); ?>

<div class="container-fluid bg-light">
    <div class="container">
        <div class="row pt-3 pb-3">
            <div class="col-12 col-md-6">
                <h1>Novo Registo de Multas</h1>
            </div>
            <div class="col-12 col-md-6 text-right">
                <a class="btn btn-primary" href="<?php echo base_url("/index.php/multas/"); ?>" ><span class="fa fa-home"></span> Cancelar</a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                <label>ID</label>
                <div class="control">
                    <input type="text" class="form-control" name="multa" value="AF<?php echo ++$a; ?>" readonly />
                    <input type="hidden" class="form-control" name="serial" value="<?php echo ++$serial; ?>" />
                </div>
            </div>
            <div class="col-md-3">
                <label>Nome *</label>
...
-->
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <!-- Hidden Field-->
                <input type="hidden" name="categoria_artigo" value="1" />
                <input type="hidden" name="visivel_artigo" value="1" />
                <input type="hidden" name="utilizador_artigo" value="<?php echo $user['id']; ?>" />
                <input type="hidden" name="criado_artigo" value="<?php echo date("Y-m-d H:i:s"); ?>" />
