...
<div class="ink-grid quarter-vertical-gutters">
    ...
    <div class="all-100 small-100 tiny-100">
        ...
        <div class="column-group">
            ...
            <h1><a href="<?php echo site_url();?>/multas/">Relatório de Multas</a></h1>
        ...
        <div class="example all-75 small-100 tiny-100">
            ...
            <div class="control-group column-group gutters">  
                ...
                <div class="control-group required all-100 small-100 tiny-100 "> 
                    ...
                    echo form_open('multas/select_id_and_date_range');
            ...
            <table id="total_servicos" class="display">
                <thead>
                    <tr>
                        <th>Matrícula</th>
                        <th>Data</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><a href="<?php echo site_url('multas/edit/'.$value->id); ?>"><?php echo $value->title; ?></a></td>
                        <td><a href="<?php echo site_url('multas/edit/'.$value->id); ?>"><?php echo $value->data; ?></a></td>
                        <td><a href="<?php echo site_url('multas/edit/'.$value->id); ?>"><?php echo $value->custo; ?></a></td>
                        <td><a href="<?php echo site_url('multas/edit/'.$value->id); ?>"><?php echo $value->km; ?></a></td>
                    </tr>
            ...
            <div class="all-100 small-100 tiny-100 small align-right">
                <a href="<?php echo base_url("/index.php/multas/total/"); ?>" class="ink-button grey"><span class="fa fa-home"></span> Cancelar</a>
        ...
        <div class="all-25 small-100 tiny-100 vertical-space">
            ...
            <nav class="ink-navigation small">
                ...
                <ul class="menu vertical blue">
                    ...
                    //echo $segment;
                    ?>
                    <li <?php if($segment == "create") { echo "class='heading active'"; } else {echo ""; } ?> ><a href="<?php echo site_url();?>/multas/create/"><span class="fa fa-cog"></span> Novo Registo</a></li>
                    <li <?php if($segment == "index") { echo "class='heading active'"; } else {echo ""; } ?> ><a href="<?php echo site_url();?>/multas/index/"><span class="fa fa-cog"></span> Registos de Multas</a></li>
                    <li <?php if($segment == "total") { echo "class='heading active'"; } else {echo ""; } ?> ><a href="<?php echo site_url();?>/multas/total/"><span class="fa fa-cog"></span> Relatórios de Multas</a></li>
