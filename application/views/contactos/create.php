...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <!-- Hidden Field-->
            <input type="hidden" name="categoria_cliente" value="1" />
            <input type="hidden" name="visivel_cliente" value="1" />
            <input type="hidden" name="utilizador_cliente" value="<?php echo $user['id']; ?>" />
            <input type="hidden" name="criado_cliente" value="<?php echo date("Y-m-d H:i:s"); ?>" />
            <input type="hidden" name="modificado_cliente" value="<?php echo date("Y-m-d H:i:s"); ?>" />
        </div>
        <!-- close row -->
    </div>
    <!-- close container -->
