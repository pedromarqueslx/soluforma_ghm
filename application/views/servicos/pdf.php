...
<font color="#000" size="8"><p style="line-height:1">O Formador</p></font>
<p color="#000"><u> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </u></p>
<font color="#000" size="8">('.$servicos['formadores_servicos'].')<br/></font>
</th>';

$orderdate = explode('-', $servicos["data_servicos"]);
$year = $orderdate[0];
$month = $orderdate[1];
$day  = $orderdate[2];
...
$table_four.='</tr>';
$table_four.='<tr>';
$table_four.='<th width="50%" style="border:0px solid #FFF" align="left"><font size="8">'.$servicos['local_formacao_servicos'].', '.$servicos['lblDataExtenso'].'</font></th>';
$table_four.='<th width="45%" style="border:0px solid #FFF" align="right">
<font color="#000" size="8">CAP Nº. EDF 38426/2004</font><br/>



<font color="#000" size="8">Certificado Nº '.$servicos['id'].'/'.$year. '&nbsp;&nbsp;'.' </font>
...
$pdf->Output($servicos['id'].'_'.'certificado_formacao_'.$servicos['nome_funcionario_servicos'].'_'.date("Y").'.pdf', 'I');
