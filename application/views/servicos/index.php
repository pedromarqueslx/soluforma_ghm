    ...
    <div class="container">
        <div class="row pt-3 pb-3">
            <div class="col-12 col-md-6">
                <h1>Certificados Emitidos em 2018</h1>
            </div>
            <div class="col-12 col-md-6 text-right">
                <a class="btn btn-success mx-auto" href="<?php echo site_url(); ?>/<?php echo 'servicos'; ?>/create/<?php echo $segment_3; ?>" >Novo Certificado</a>
            </div>
        </div>
    </div>
</div>
                ...
                <table class="table table-striped" id="index_servicos">
                    ...
                    <?php foreach($results as $data) {?>
                        <tr>
                            ...
                            <td><a target="_blank" class="btn btn-primary ml-4" href="<?php echo site_url(); ?>/<?php echo 'servicos'; ?>/pdf/<?php echo $data->id; ?>" >PDF</a></td>
                            <td><a target="_blank" class="btn btn-primary ml-4" href="<?php echo site_url(); ?>/<?php echo 'servicos'; ?>/pdf2/<?php echo $data->id; ?>" >PDF</a></td>
                        </tr>
                    <?php } ?>
                    </tbody>
                    <tfoot>
