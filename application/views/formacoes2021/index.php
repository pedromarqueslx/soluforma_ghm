...
<table class="table table-striped" id="index_servicos">
    ...
    <td><a target="_blank" class="btn btn-primary ml-4" href="<?php echo site_url('formacoes2021/edit/'.($data['numero_cliente'])); ?>" >Formação</a></td>
    <td><a target="_blank" class="btn btn-primary ml-4" href="<?php echo site_url('formacoes2021/funcionarios/'.($data['numero_cliente'])); ?>" >S/Formação</a></td>
    </tr>
    </tr>
    <?php } ?>
</tbody>
