...
$table.='</tr>';
$table .= '<tr>
				<td style="border:1px solid #CCCCCC" >'.$servicos['title'].'</td>
				<td style="border:1px solid #CCCCCC">'.$servicos['preco_servicos'].'</td>
				<td style="border:1px solid #CCCCCC">'.$servicos['data_servicos'].'</td>
				<td style="border:1px solid #CCCCCC">'.$servicos['funcionario_servicos'].'</td>
				<td style="border:1px solid #CCCCCC">'.$servicos['equipamento_servicos'].'</td>
			</tr>';
	$table.='</table>';
...
$table_line_two.='</tr>';
$table_line_two .= '<tr>
				<td style="border:1px solid #CCCCCC">'.$servicos['equipamento_dois_servicos'].'</td>
				<td style="border:1px solid #CCCCCC">'.$servicos['cmr_servicos'].'</td>
				<td style="border:1px solid #CCCCCC">'.$servicos['km_servicos'].'</td>
				<td style="border:1px solid #CCCCCC">'.$servicos['data_fatura_servicos'].'</td>
				<td style="border:1px solid #CCCCCC">'.$servicos['fatura_servicos'].'</td>
			</tr>';
