...
<?php echo form_open('servicos2019/edit/'.$servicos_item['id']); ?>
<form>
<div class="container">
<div class="row">
...
<div class="col-md-8">
    ...
    <a class="btn btn-primary" href="<?php echo base_url("/index.php/servicos2019/pdf/". $servicos_item['id'] ); ?>" target="_blank">Emitir Certificado</a>
