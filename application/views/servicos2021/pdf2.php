...
// set bacground image
$img_file = K_PATH_IMAGES.'background_white.jpg';
...
$table_four.='<th width="55%" style="border:none" align="left"><font size="8">'.$servicos['local_formacao_servicos'].', '.$servicos['lblDataExtenso'].'</font></th>';
$table_four.='<th width="40%" style="border:none" align="right">
<br/>
<br/>
<br/>
<font color="#000" size="8"><p>Certificado Nº '.$servicos['id'].'/'.$year. '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.' </p></font>
