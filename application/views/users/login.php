        ...
        <div class="row">
            <div class="col text-center">
                <a href="<?php echo site_url(); ?>">
                    <img class="m-2 mx-auto" src="<?php echo base_url("/assets/img/logosoluforma.svg"); ?>" style="height:85px">
                </a>
                <h1 class="text-center" style="color: black">Gestão de Histórico de Multas</h1>
            </div>
        </div>
