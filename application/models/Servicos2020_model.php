...
class Servicos2020_model extends CI_Model {
...
public function get_servicos_by_matricula($id = 0) {
    ...
    $query = $this->db->get_where('servicos2020', array('matricula_servicos' => $id));
    return $query->row_array();
}
...
public function set_servicos($data) {
    ...
    if ($data > 0) {
    return $this->db->insert_batch('servicos2020', $data);
    }
}
