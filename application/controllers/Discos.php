...
class Discos extends CI_Controller {
    ...
    public function pdf() {
        ...
        $data['discos'] = $this->discos_model->get_servicos_by_id($id);
        //$data['servicos_item'] = $this->discos_model->get_servicos_by_id($id);
    ...
    public function index() {
        ...
        if ($this->session->userdata('isUserLoggedIn')) {
            ...
            $config["total_rows"] = $this->discos_model->record_count();
            $config["per_page"] = '';
            ...
            $data["results"] = $this->discos_model->fetch_servicos($config["per_page"], $page);
    ...
    public function autocomplete() {
        ...
        $result = $this->discos_model->get_autocomplete($search_data);
        if (!empty($result)) {
    ...
    public function autocomplete_create() {
        // load model
        $search_data = $this->input->post('search_data');
        $result = $this->discos_model->get_autocomplete_create($search_data);
        if (!empty($result)) {
            echo "<table class='ink-table hover alternating'>";
            foreach ($result as $row):
                echo "<tr><td>";
    ...
    public function view ($slug = NULL) {
        $data['servicos_item'] = $this->discos_model->get_servicos($slug);
    ...
    public function create() {
        ...
        if ($this->session->userdata('isUserLoggedIn')) {
            ...
            $data['servicos'] = $this->discos_model->get_servicos();
            ...
            if ($this->form_validation->run() === FALSE) {
                ...
                $this->discos_model->set_servicos($data);
    ...
    public function getFuncionariosbyempresa() {
        ...
        // get data
        $data = $this->discos_model->getEmpresas($postData);
    ...
    public function getConteudosbyareaformacao() {
        ...
        $postData = $this->input->post();
        // get data
        $data = $this->discos_model->getConteudos($postData);
        echo json_encode($data);
    }
    ...
    public function getInfracoesbyareaformacao() {
        ...
        $postData = $this->input->post();
        // get data
        $data = $this->discos_model->geInfracoes($postData);
        echo json_encode($data);
    }
    ...
    public function getConteudosbyIDareaformacao() {
        ...
        $postData = $this->input->post();
        // get data
        $data = $this->discos_model->getConteudosbyID($postData);
        echo json_encode($data);
    }
    ...
    public function getInfracoesbyIDareaformacao() {
        ...
        $postData = $this->input->post();
        // get data
        $data = $this->discos_model->getInfracoesbyID($postData);
        echo json_encode($data);
    }
    ...
    public function edit() {
        ...
        if ($this->session->userdata('isUserLoggedIn')) {
            ...
            if ($this->form_validation->run() === FALSE) {
                ...
                $this->discos_model->set_servicos_id($id);
                redirect( base_url() . 'index.php/discos/index/');
            }}else{
            // if user is NOT loggedIn redirect to homepage
            redirect( base_url() );
    ...
    public function total() {
        ...
        if ($this->session->userdata('isUserLoggedIn')) {
            ...
            $data['equipamentos_item'] = $this->discos_model->get_servicos_by_title($id);
            $data['servicos'] = $this->discos_model->get_servicos_by_title();
    ...
    public function delete() {
        ...
        $servicos_item = $this->discos_model->get_servicos_by_id($id);
        $this->discos_model->delete_servicos($id);
        redirect( base_url() . 'index.php/discos');
    }

    // function to get all artigos records :: COMMENT LATER
    public function view_table() {
        $result = $this->discos_model->show_all_data();
        if ($result != false) {
            return $result;
        }else{
    ...
    public function select_id_and_date_range() {
        ...
        if ($date1 == "" || $date2 == "" || $id == "") {
            ...
            $result = $this->discos_model->select_id_and_date_range($data);
            if ($result != false) {
