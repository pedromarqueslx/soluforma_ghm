...
$query = $this->db->where('visivel_servicos', '1')->where('categoria_servicos', '1')->limit(6)->order_by("id", "desc");
$data['servicos'] = $this->servicos_model->get_servicos();
$query = $this->db->where('visivel_cliente', '1')->where('categoria_cliente', '1')->limit(6)->order_by("id", "desc");
